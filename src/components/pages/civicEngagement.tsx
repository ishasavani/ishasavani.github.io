  ...
  return (
    <div id="civic-engagement-page">
      <BasePage title="Civic Engagement">
        Civic engagement allows the coming together of different perspectives in
        order to better understand the various dimensions of a problem of common
        interest or concern. In the context of availability and distribution of
        critical resources such as water, I work with other academics,
        interested members of the community, governments and industries so that
        the social, political, economical and scientific dimensions of the
        problem can be better understood. This engagement inevitably leads to
        ...
        <span className="italic font-bold">
          ...
          along with Norwegian Ambassador to Kenya Mr. Gunnar Andreas Holm, for
          an exiting discussion on the indications of fresh water in deep
        ...
        <br />
        To the Government of Norway, Ministry of Foreign Affairs, Department of
        water, climate change and sustainability, Oslo, Noway, February 2023
        <br />
        <br />
        <span className="italic font-bold">
        ...
        Kenya, November 24-26, 2022. Side note: I unfortunately could not attend
        the event due to catching covid. My colleague delivered the talk
        instead.
        <br />
        <br />
        <span className="italic font-bold">
        ...
        <br />
        At the occation of the Round table conference bringing together
        Norwegian Ambassador Gunnar Andreas Holm, World Food Program, Innovation
        Norway at the Agri-Delegation Conference, Nairobi, Kenya, April 2022
        <br />
        <br />
        <span className="italic font-bold">
        ...
        <br />
        To the United Nations Food and Agriculture Organization, Nairobi, Kenya,
        April 2022
        <br />
        <br />
